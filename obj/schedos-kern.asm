...
schedule(void)
{
  ...
  1000c9:	eb 39                	jmp    100104 <schedule+0x68>
		}

	if(scheduling_algorithm == 1){
  1000cb:	83 f8 01             	cmp    $0x1,%eax
  1000ce:	75 3f                	jne    10010f <schedule+0x73>
		pid_t next_pid =0;
  ...
  1000d7:	74 25                	je     1000fe <schedule+0x62>
  1000d9:	83 3d 0c 71 10 00 01 	cmpl   $0x1,0x10710c
  1000e0:	b0 02                	mov    $0x2,%al
  1000e2:	74 1a                	je     1000fe <schedule+0x62>
  1000e4:	83 3d 5c 71 10 00 01 	cmpl   $0x1,0x10715c
  1000eb:	b0 03                	mov    $0x3,%al
  1000ed:	74 0f                	je     1000fe <schedule+0x62>
  1000ef:	31 c0                	xor    %eax,%eax
  1000f1:	83 3d ac 71 10 00 01 	cmpl   $0x1,0x1071ac
  1000f8:	0f 94 c0             	sete   %al
  1000fb:	c1 e0 02             	shl    $0x2,%eax
					next_pid = i;
					break;
				}
		}
  ...
  1000fe:	6b c0 50             	imul   $0x50,%eax,%eax
  100101:	83 ec 0c             	sub    $0xc,%esp
  100104:	05 24 70 10 00       	add    $0x107024,%eax
  100109:	50                   	push   %eax
  10010a:	e8 a6 03 00 00       	call   1004b5 <run>

	}
	// If we get here, we are running an unknown scheduling algorithm.
	cursorpos = console_printf(cursorpos, 0x100, "\nUnknown scheduling algorithm %d\n", scheduling_algorithm);
  10010f:	8b 15 00 80 19 00    	mov    0x198000,%edx
  100115:	50                   	push   %eax
  100116:	68 74 0a 10 00       	push   $0x100a74
  10011b:	68 00 01 00 00       	push   $0x100
  100120:	52                   	push   %edx
  100121:	e8 34 09 00 00       	call   100a5a <console_printf>
  100126:	83 c4 10             	add    $0x10,%esp
  100129:	a3 00 80 19 00       	mov    %eax,0x198000
  10012e:	eb fe                	jmp    10012e <schedule+0x92>
