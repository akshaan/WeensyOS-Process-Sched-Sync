...
multiboot_start:
  ...
  100013:	9d                   	popf   
	call start
  100014:	e8 e9 01 00 00       	call   100202 <start>
  100019:	90                   	nop
...
schedule(void)
{
  ...
  1000a0:	a1 94 7f 10 00       	mov    0x107f94,%eax
  1000a5:	8b 10                	mov    (%eax),%edx

	if (scheduling_algorithm == 0)
  1000a7:	a1 98 7f 10 00       	mov    0x107f98,%eax
  ...
  1000be:	83 b8 d0 75 10 00 01 	cmpl   $0x1,0x1075d0(%eax)
  ...
  1000d1:	83 3d 24 76 10 00 01 	cmpl   $0x1,0x107624
  1000d8:	74 25                	je     1000ff <schedule+0x63>
  1000da:	83 3d 78 76 10 00 01 	cmpl   $0x1,0x107678
  1000e1:	b0 02                	mov    $0x2,%al
  1000e3:	74 1a                	je     1000ff <schedule+0x63>
  1000e5:	83 3d cc 76 10 00 01 	cmpl   $0x1,0x1076cc
  1000ec:	b0 03                	mov    $0x3,%al
  1000ee:	74 0f                	je     1000ff <schedule+0x63>
  1000f0:	31 c0                	xor    %eax,%eax
  1000f2:	83 3d 20 77 10 00 01 	cmpl   $0x1,0x107720
  ...
  100105:	05 88 75 10 00       	add    $0x107588,%eax
  10010a:	50                   	push   %eax
  10010b:	e8 0d 04 00 00       	call   10051d <run>
  ...
  10011c:	8b 88 2c 76 10 00    	mov    0x10762c(%eax),%ecx
  100122:	39 d9                	cmp    %ebx,%ecx
  100124:	7d 09                	jge    10012f <schedule+0x93>
  100126:	83 b8 24 76 10 00 01 	cmpl   $0x1,0x107624(%eax)
  ...
  10014d:	83 b8 d0 75 10 00 01 	cmpl   $0x1,0x1075d0(%eax)
  100154:	75 0f                	jne    100165 <schedule+0xc9>
  100156:	05 88 75 10 00       	add    $0x107588,%eax
  ...
  100170:	50                   	push   %eax
  100171:	68 dc 0a 10 00       	push   $0x100adc
  100176:	68 00 01 00 00       	push   $0x100
  10017b:	52                   	push   %edx
  10017c:	e8 41 09 00 00       	call   100ac2 <console_printf>
...
interrupt(registers_t *reg)
{
  ...
  10018c:	8b 3d 94 7f 10 00    	mov    0x107f94,%edi
...
interrupt(registers_t *reg)
{
  ...
  1001a7:	83 f8 31             	cmp    $0x31,%eax
  1001aa:	74 1f                	je     1001cb <interrupt+0x40>
  1001ac:	77 0c                	ja     1001ba <interrupt+0x2f>
  1001ae:	83 f8 20             	cmp    $0x20,%eax
  1001b1:	74 48                	je     1001fb <interrupt+0x70>
  1001b3:	83 f8 30             	cmp    $0x30,%eax
  1001b6:	74 0e                	je     1001c6 <interrupt+0x3b>
  1001b8:	eb 46                	jmp    100200 <interrupt+0x75>
  1001ba:	83 f8 32             	cmp    $0x32,%eax
  1001bd:	74 23                	je     1001e2 <interrupt+0x57>
  1001bf:	83 f8 33             	cmp    $0x33,%eax
  1001c2:	74 29                	je     1001ed <interrupt+0x62>
  1001c4:	eb 3a                	jmp    100200 <interrupt+0x75>

	case INT_SYS_YIELD:
		// The 'sys_yield' system call asks the kernel to schedule
		// the next process.
		schedule();
  1001c6:	e8 d1 fe ff ff       	call   10009c <schedule>
  ...
  1001cb:	a1 94 7f 10 00       	mov    0x107f94,%eax
		current->p_exit_status = reg->reg_eax;
  1001d0:	8b 53 1c             	mov    0x1c(%ebx),%edx
		// The application stored its exit status in the %eax register
		// before calling the system call.  The %eax register has
		// changed by now, but we can read the application's value
		// out of the 'reg' argument.
		// (This shows you how to transfer arguments to system calls!)
		current->p_state = P_ZOMBIE;
  1001d3:	c7 40 48 03 00 00 00 	movl   $0x3,0x48(%eax)
		current->p_exit_status = reg->reg_eax;
  1001da:	89 50 4c             	mov    %edx,0x4c(%eax)
		schedule();
  1001dd:	e8 ba fe ff ff       	call   10009c <schedule>
  ...
  1001e2:	8b 53 1c             	mov    0x1c(%ebx),%edx
  1001e5:	a1 94 7f 10 00       	mov    0x107f94,%eax
  1001ea:	89 50 50             	mov    %edx,0x50(%eax)

	case INT_SYS_USER2:
		/* Your code here (if you want). */
		run(current);
  1001ed:	83 ec 0c             	sub    $0xc,%esp
  1001f0:	ff 35 94 7f 10 00    	pushl  0x107f94
  1001f6:	e8 22 03 00 00       	call   10051d <run>
	...
	case INT_CLOCK:
		...
		schedule();
  1001fb:	e8 9c fe ff ff       	call   10009c <schedule>
  100200:	eb fe                	jmp    100200 <interrupt+0x75>
...
start(void)
{
  ...
  100203:	bf 00 00 30 00       	mov    $0x300000,%edi
 *
 *****************************************************************************/
...
start(void)
{
  10020b:	53                   	push   %ebx
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  10020c:	bb dc 75 10 00       	mov    $0x1075dc,%ebx
start(void)
{
	int i;
  ...
  100220:	e8 5b 02 00 00       	call   100480 <console_clear>
	...
	// Initialize process descriptors as empty
	memset(proc_array, 0, sizeof(proc_array));
  100225:	83 c4 0c             	add    $0xc,%esp
  100228:	68 a4 01 00 00       	push   $0x1a4
  10022d:	6a 00                	push   $0x0
  10022f:	68 88 75 10 00       	push   $0x107588
  100234:	e8 27 04 00 00       	call   100660 <memset>
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  100239:	83 c4 10             	add    $0x10,%esp
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10023c:	c7 05 88 75 10 00 00 	movl   $0x0,0x107588
  100243:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100246:	c7 05 d0 75 10 00 00 	movl   $0x0,0x1075d0
  10024d:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100250:	c7 05 dc 75 10 00 01 	movl   $0x1,0x1075dc
  100257:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  10025a:	c7 05 24 76 10 00 00 	movl   $0x0,0x107624
  100261:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100264:	c7 05 30 76 10 00 02 	movl   $0x2,0x107630
  10026b:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  10026e:	c7 05 78 76 10 00 00 	movl   $0x0,0x107678
  100275:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100278:	c7 05 84 76 10 00 03 	movl   $0x3,0x107684
  10027f:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100282:	c7 05 cc 76 10 00 00 	movl   $0x0,0x1076cc
  100289:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10028c:	c7 05 d8 76 10 00 04 	movl   $0x4,0x1076d8
  100293:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100296:	c7 05 20 77 10 00 00 	movl   $0x0,0x107720
  10029d:	00 00 00 
	for (i = 1; i < NPROCS; i++) {
  ...
  1002a3:	53                   	push   %ebx
  1002a4:	e8 8b 02 00 00       	call   100534 <special_registers_init>
  ...
  1002a9:	58                   	pop    %eax
  1002aa:	5a                   	pop    %edx
  1002ab:	8d 43 34             	lea    0x34(%ebx),%eax
		...
		// Set ESP
		proc->p_registers.reg_esp = stack_ptr;
  1002ae:	89 7b 40             	mov    %edi,0x40(%ebx)
		...
		proc->p_priority = 0;
  1002b1:	81 c7 00 00 10 00    	add    $0x100000,%edi
  ...
  1002b9:	46                   	inc    %esi
		...
		// Load process and set EIP, based on ELF image
		program_loader(i - 1, &proc->p_registers.reg_eip);
  1002ba:	e8 b1 02 00 00       	call   100570 <program_loader>
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
  ...
  1002bf:	83 c4 10             	add    $0x10,%esp
		...
		// Mark the process as runnable!
		proc->p_state = P_RUNNABLE;
  1002c2:	c7 43 48 01 00 00 00 	movl   $0x1,0x48(%ebx)

		// Set initial priorities to zero
		proc->p_priority = 0;
  1002c9:	c7 43 50 00 00 00 00 	movl   $0x0,0x50(%ebx)
  1002d0:	83 c3 54             	add    $0x54,%ebx
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
  ...
  1002d6:	75 c8                	jne    1002a0 <start+0x9e>
	...
	run(&proc_array[1]);
  1002d8:	83 ec 0c             	sub    $0xc,%esp
  1002db:	68 dc 75 10 00       	push   $0x1075dc
		proc->p_priority = 0;
	}
  ...
  1002e0:	c7 05 00 80 19 00 00 	movl   $0xb8000,0x198000
  1002e7:	80 0b 00 

	// Initialize the scheduling algorithm.
	scheduling_algorithm = 0;
  1002ea:	c7 05 98 7f 10 00 00 	movl   $0x0,0x107f98
  1002f1:	00 00 00 

	// Switch to the first process.
	run(&proc_array[1]);
  1002f4:	e8 24 02 00 00       	call   10051d <run>
  1002f9:	90                   	nop
  1002fa:	90                   	nop
  1002fb:	90                   	nop
...
segments_init(void)
{
  ...
  1002fc:	b8 2c 77 10 00       	mov    $0x10772c,%eax
...
segments_init(void)
{
  ...
  10031d:	88 15 3c 10 10 00    	mov    %dl,0x10103c
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  100323:	ba 94 77 10 00       	mov    $0x107794,%edx
segments_init(void)
{
	int i;
...
segments_init(void)
{
  ...
  100346:	c7 05 30 77 10 00 00 	movl   $0x180000,0x107730
  10034d:	00 18 00 
	kernel_task_descriptor.ts_ss0 = SEGSEL_KERN_DATA;
  100350:	66 c7 05 34 77 10 00 	movw   $0x10,0x107734
  100357:	10 00 
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  100359:	66 89 0c c5 94 77 10 	mov    %cx,0x107794(,%eax,8)
  100360:	00 
  ...
  10037f:	b8 1a 00 10 00       	mov    $0x10001a,%eax
	...
	for (i = INT_SYS_YIELD; i < INT_SYS_YIELD + 10; i++)
		SETGATE(interrupt_descriptors[i], 0,
  100384:	ba 94 77 10 00       	mov    $0x107794,%edx
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
			SEGSEL_KERN_CODE, default_int_handler, 0);
	...
	// The clock interrupt gets special handling
	SETGATE(interrupt_descriptors[INT_CLOCK], 0,
  100389:	66 a3 94 78 10 00    	mov    %ax,0x107894
  10038f:	c1 e8 10             	shr    $0x10,%eax
  100392:	66 a3 9a 78 10 00    	mov    %ax,0x10789a
  100398:	b8 30 00 00 00       	mov    $0x30,%eax
  10039d:	66 c7 05 96 78 10 00 	movw   $0x8,0x107896
  1003a4:	08 00 
  1003a6:	c6 05 98 78 10 00 00 	movb   $0x0,0x107898
  1003ad:	c6 05 99 78 10 00 8e 	movb   $0x8e,0x107899
  ...
  1003c2:	66 89 0c c5 94 77 10 	mov    %cx,0x107794(,%eax,8)
  1003c9:	00 
...
outb(int port, uint8_t data)
{
  ...
  100472:	ee                   	out    %al,(%dx)
  100473:	b0 a9                	mov    $0xa9,%al
  100475:	b2 40                	mov    $0x40,%dl
  100477:	ee                   	out    %al,(%dx)
  100478:	b0 04                	mov    $0x4,%al
  10047a:	ee                   	out    %al,(%dx)
...
run(process_t *proc)
{
  10051d:	8b 44 24 04          	mov    0x4(%esp),%eax
	current = proc;
  100521:	a3 94 7f 10 00       	mov    %eax,0x107f94

	asm volatile("movl %0,%%esp\n\t"
  100526:	83 c0 04             	add    $0x4,%eax
...
special_registers_init(process_t *proc)
{
  ...
  100540:	8d 43 04             	lea    0x4(%ebx),%eax
  100543:	50                   	push   %eax
  100544:	e8 17 01 00 00       	call   100660 <memset>
	proc->p_registers.reg_cs = SEGSEL_APP_CODE | 3;
  100549:	66 c7 43 38 1b 00    	movw   $0x1b,0x38(%ebx)
	proc->p_registers.reg_ds = SEGSEL_APP_DATA | 3;
  10054f:	66 c7 43 28 23 00    	movw   $0x23,0x28(%ebx)
	proc->p_registers.reg_es = SEGSEL_APP_DATA | 3;
  100555:	66 c7 43 24 23 00    	movw   $0x23,0x24(%ebx)
	proc->p_registers.reg_ss = SEGSEL_APP_DATA | 3;
  10055b:	66 c7 43 44 23 00    	movw   $0x23,0x44(%ebx)
	// Enable interrupts
	proc->p_registers.reg_eflags = EFLAGS_IF;
  100561:	c7 43 3c 00 02 00 00 	movl   $0x200,0x3c(%ebx)
}
